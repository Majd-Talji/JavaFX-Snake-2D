...
public class Main extends Application {
    ...
    private int readBestScorefromTheFile() {
        try {
            FileInputStream file = new FileInputStream("./snake-game-best-score.txt");
    ...
    private void drawShapes(GraphicsContext gc) {
        ...
        gc.fillText("Entwickelt von Majd Talji", 540, 60);
        ...
        gc.fillText("lookTo Up : Arrow Up", 550, 410);
        gc.fillText("lookTo Down : Arrow Down", 550, 435);
        gc.fillText("lookTo Left : Arrow Left", 550, 460);
        gc.fillText("lookTo Right : Arrow Right", 550, 485);
    ...
    public void start(Stage stage) throws Exception {
        ...
        Scene scene = new Scene(root, 750, 491);
